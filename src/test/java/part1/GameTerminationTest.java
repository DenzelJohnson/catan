...
public class GameTerminationTest {
    ...
    static class WinnerComputerPlayer extends ComputerPlayer {
        ...
        public String turn(Board board) {
            addVictoryPoints(10); // instantly reach 10 VP
            return "Forcing win for test";
        }
    }
    ...
    void stopsEarlyWhenSomeoneReaches10VP() {
        ...
        // If you added the (board, players, maxRounds) constructor for R1.4, use it:
    ...
    void stopsAfterMaxRoundsIfNoOneWins() {
        ...
        // OPTIONAL: count round summaries if your displayRoundSummary prints something consistent.
        // Replace "Round Summary" with the exact text your game prints each round.
        // int roundsPrinted = output.split("Round Summary", -1).length - 1;
        // assertTrue(roundsPrinted <= 3);
    }
